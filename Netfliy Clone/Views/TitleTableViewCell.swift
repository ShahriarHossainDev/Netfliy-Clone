...
class TitleTableViewCell: UITableViewCell {
    ...
    private func applyConstraints() {
        let titlePosterImageViewConstains = [
        ...
        NSLayoutConstraint.activate(titlePosterImageViewConstains)
        NSLayoutConstraint.activate(titleLabelConstains)
